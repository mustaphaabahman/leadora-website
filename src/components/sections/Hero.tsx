  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          Agence Premium de Génération de Leads
        </motion.div>
        ...
        >
          Multipliez la Croissance <br className="hidden md:block" />
        ...
        >
          Leadora aide les entreprises ambitieuses à générer plus de clients qualifiés grâce à la publicité à fort taux de conversion, au contenu créatif, aux sites Web, aux pages de destination et à la stratégie marketing.
        </motion.p>
