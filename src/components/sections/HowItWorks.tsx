...
const steps = [
  { number: "01", title: "Fill the form", desc: "Tell us about your business goals." },
  { number: "02", title: "We analyze your business", desc: "Our team conducts a deep audit." },
  { number: "03", title: "We create your growth strategy", desc: "A tailored plan to multiply revenue." },
  { number: "04", title: "We launch", desc: "Execution of campaigns and creatives." },
  { number: "05", title: "You scale", desc: "Watch your revenue and leads soar." }
];
    ...
    <section id="how-it-works" className="py-32 relative z-10">
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          >
            A simple, proven process to scale your business.
          </motion.p>
        </div>
